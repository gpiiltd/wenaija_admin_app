  ...
  return (
    ...
    <div className="relative">
      <textarea
        ...
        className={`mt-1 block text-light_gray text-base tracking-wide w-full px-3 py-2 border border-primary_color rounded-md shadow-sm focus:outline-none placeholder-primary_color placeholder-opacity-50 placeholder-xs`}
        {...field}
        {...props}
        onBlur={handleBlur}
