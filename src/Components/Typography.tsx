...
const Typography: React.FC<TypographyProps> = ({
  ...
  const classes: Record<TypographyVariant, string> = {
    [TypographyVariant.TITLE]: "text-[25px] tracking-tight leading-[38px] font-semibold text-black font-title",
    [TypographyVariant.SUBTITLE]: "font-semibold text-[15px] leading-[26px] text-l_black font-title",
