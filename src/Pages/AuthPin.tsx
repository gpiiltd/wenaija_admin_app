  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center">
      <div className="text-center w-full">
        <h1 className="text-2xl font-bold mb-2">Create authentication pin</h1>
      ...
      <button onClick={openDialog}
                className="bg-[#007A61] py-3 w-full rounded-lg mt-10 text-white text-sm font-normal">Submit</button>
    </div>
    </AuthPages>
    </div>
  );
