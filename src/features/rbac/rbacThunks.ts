...
>("rbac/list_all_accounts", async (params, thunkAPI) => {
  try {
...
export const triggerListASingleUser = createAsyncThunk<
  ...
  string,
  { rejectValue: ErroResponseData }
>("rbac/get_a_user", async (params, thunkAPI) => {
  try {
...
export const triggerGetAllRoles = createAsyncThunk<
  ...
  Record<string, string>,
  { rejectValue: ErroResponseData }
>("rbac/get_roles", async (params, thunkAPI) => {
  try {
...
export const triggerAddRole = createAsyncThunk<
  ...
  { rejectValue: ErroResponseData }
>("rbac/add_role", async (params, thunkAPI) => {
  try {
...
export const triggerGetPermissions = createAsyncThunk<
  ...
  { rejectValue: ErroResponseData }
>("rbac/get_permissions", async (params, thunkAPI) => {
  try {
...
export const triggerEditRolesAndPermissions = createAsyncThunk<
  ...
  { rejectValue: ErroResponseData }
>("rbac/edit_roles_permissions", async ({ id, data }, thunkAPI) => {
  try {
